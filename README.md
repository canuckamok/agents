...
The JSON files have placeholder credentials. You need to bring your own API keys for OpenAI, Anthropic, Perplexity, Gmail, Google Calendar, and/or Telegram depending on which agent you're setting up.
